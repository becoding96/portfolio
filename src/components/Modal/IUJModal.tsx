            ...
            <div className={styles["text-div"]}>
              ...
              <div className={styles.contents}>
                ...
                <details>
                  ...
                  <li>
                    <span>Kakao MAP API</span>를 이용해 구현했습니다.
                  </li>
                  <li>
                    <span>
                      지도의 매물은 점수에 비례하여 채도가 바뀌는 집 모양의
                      마커로 커스텀
                    </span>
                    했습니다.
                  </li>
                  <li>
                    <span>순수 CSS로 차트를 구현</span>하여 주변 선호 시설 설정
                    시 가독성을 높일 수 있도록 했습니다.
                  </li>
                  <li>
                    <span>추천 점수에 대한 상세 근거</span>를 직접 구현한
                    그래프로 볼 수 있도록 했습니다. (ex. 병원 70, 지하철 60...)
                  </li>
                  <li>
                    <span>필터 기능</span>을 구현하여 불필요한 로딩을
                    줄였습니다.
                  </li>
                </details>
                <details>
                ...
                <li>
                  ...
                  해보았고, 이를 통해 컴포넌트 구현력과 CSS에 대한 이해도가
                  증가했습니다.
                </li>
              </div>
            </div>
