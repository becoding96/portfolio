    ...
    <div id={styles.container} ref={projectsRef}>
      ...
      >
        <ProjectCard
          ...
          projectFrom="삼성 청년 SW 아카데미 자율 프로젝트 (6인)"
          projectAward="우수상 (2등)"
          ...
          projectRole={[
            "프론트엔드 팀장, 디자인을 담당했습니다.",
            "소셜 로그인, 메인 페이지, 레포지토리 분석 페이지, 랭킹페이지, 크롬 익스텐션을 제작했습니다.",
          ]}
        />
        <ProjectCard
          projectTitle="아이유정"
          ...
          projectFrom="삼성 청년 SW 아카데미 특화 프로젝트 (6인)"
          ...
          projectRole={[
            "프론트엔드 팀장, 디자인을 담당했습니다.",
            "소셜 로그인, 메인 페이지, 지도 페이지, 관심 매물 페이지를 제작했습니다.",
          ]}
        />
        <ProjectCard
          projectTitle="펀티어"
          ...
          projectFrom="삼성 청년 SW 아카데미 공통 프로젝트 (6인)"
          ...
          projectRole={[
            "프론트엔드 팀원, 디자인을 담당했습니다.",
            "회원가입(개인, 단체), 관리자 페이지, 충전 및 환불(아임포트), 프로필 페이지, 고객센터, 서비스 소개를 제작했습니다.",
          ]}
        />
      </div>
    </div>
